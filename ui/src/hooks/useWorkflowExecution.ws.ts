  ...
  switch (msg.type) {
    ...
    case 'tool_result': {
      ...
      if (toolName === 'view_image') {
        ...
        if (image) {
          return {
            ...
            content: buildToolResultContent(toolName, 'success', duration, undefined, toolInput, output),
            timestamp,
            images: [image],
      ...
      return {
        ...
        toolDurationMs: duration,
        content: buildToolResultContent(toolName, status, duration, failureText, toolInput, output),
        ...(toolInput !== undefined ? { toolInput } : {}),
