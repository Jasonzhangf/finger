...
export const contextLedgerMemoryTool: InternalTool<unknown, ContextLedgerMemoryToolOutput> = {
  ...
  description: [
    ...
    'Default dynamic history budget is 20k tokens; for topic switches or coding work that needs more context, pair this with context_history.rebuild (try rebuild_budget=50000 before 110000).',
