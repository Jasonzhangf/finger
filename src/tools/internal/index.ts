...
import { patchTool } from './codex-patch-tool.js';
...
import { contextHistoryRebuildTool } from './context-history-rebuild-tool.js';
...
export * from './codex-patch-tool.js';
...
export * from './context-history-rebuild-tool.js';
...
export function createDefaultInternalToolRegistry(): InternalToolRegistry {
  ...
  registry.register(contextHistoryRebuildTool);
