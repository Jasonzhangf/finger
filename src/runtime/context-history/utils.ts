...
/** 获取最近几轮对话 */
export function getRecentRounds(messages: SessionMessage[], keepRounds: number): ConversationRound[] {
  const allRounds = groupMessagesByRound(messages);
  return allRounds.slice(-keepRounds);
}
